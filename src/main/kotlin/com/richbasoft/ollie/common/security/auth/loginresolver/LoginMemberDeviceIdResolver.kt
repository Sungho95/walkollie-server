...
class LoginMemberDeviceIdResolver : HandlerMethodArgumentResolver {
    override fun supportsParameter(parameter: MethodParameter): Boolean {
        val hasAnnotation = parameter.hasParameterAnnotation(LoginMemberDeviceId::class.java)
        val hasStringType = String::class.java.isAssignableFrom(parameter.parameterType)
