package com.richbasoft.ollie.domain.inquiry.dto.response
...
@Schema
data class InquiryInfoDto @QueryProjection constructor(
    ...
    companion object {
        fun from(inquiry: Inquiry): InquiryInfoDto {
...
@Schema
data class InquiryInfoDetailDto @QueryProjection constructor(
    @field:Schema(example = "1")
    val inquiryId: Long,
    ...
    companion object {
        fun from(inquiry: Inquiry): InquiryInfoDetailDto {
            return InquiryInfoDetailDto(
                inquiryId = inquiry.id!!,
                memberId = inquiry.ollie.id!!,
                ollieName = inquiry.ollie.name,
                title = inquiry.title,
